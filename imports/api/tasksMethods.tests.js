...
if (Meteor.isServer) {
  describe("Tasks", () => {
    describe("methods", () => {
      ...
      /* Creating a new task before each test. */
      beforeEach(() => {
      ...
      /* Testing the method tasks.remove. */
      ...
      /* Testing that the user is authenticated. */
      ...
      /* Testing the method tasks.setIsChecked. */
      ...
      /* Testing the method tasks.insert. */
